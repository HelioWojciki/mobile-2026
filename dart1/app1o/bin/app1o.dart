import 'package:app1o/app1o.dart' as app1o;
...
//   servico.processarPedido("Pedido #12345");
// }
...
void exemploException() {
  ...
  try {
    ...
    print("Erro ao realizar o saque: ${e.toString()}");
  } finally {
...
void exemploNullSafety() {
  ...
  String? nomeDoProduto = null; // variável que pode ser nula

  if (nomeDoProduto != null) {
    print("O nome do produto é: $nomeDoProduto");
  } else {
    print("O nome do produto não não disponível.");
  }
}

void main() {  
  // exemplosTipos();
  // exemplosDecisaoRepeticao();
  // arrays();
  // estruturaRepeticao();
  // print(printaCerveja("SKOL"));
  // classeExemplo();
  // exemploMap();
  // exemploClasse(); // lembrar sempre do .this no construtor
  // funcaoAnonima();
  // exemploAbstracao();
  // exemploException();
  exemploNullSafety();
